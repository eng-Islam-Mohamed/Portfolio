...
const CREDITS = [
    { title: 'Portfolio & Selected Projects', rows: [['Mohamed Islam', 'Web, Mobile & AI Projects'], ['ESI', 'Software Engineering']] },
    {
        title: 'Engineering & Design',
        rows: [['Mohamed Islam', 'Portfolio Adaptation & Project Integration']],
    },
    {
...
const Credits: React.FC<CreditsProps> = (props) => {
    ...
    return (
        ...
        >
            ...
            >
                <h2>Credits</h2>
                <p>Mohamed Islam · Software Engineering Portfolio</p>
                <br />
                <br />
                <br />
